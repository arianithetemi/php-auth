              ...
              <div class="row">
                <div class="col-lg-12">
                    ...
                    <form id="register-form" action="register.php" method="POST" role="form" data-parsley-validate style="display: none;">
                      ...
                      <div class="form-group">
                        <input type="password" name="confirm_password" id="confirm-password" tabindex="2" class="form-control" placeholder="Confirm Password" data-parsley-trigger="change" required data-parsley-minlength="6" data-parsley-equalto="#password">
                      </div>
                      <div class="form-group">
                        <div class="row">
                          <div class="col-sm-6 col-sm-offset-3">
